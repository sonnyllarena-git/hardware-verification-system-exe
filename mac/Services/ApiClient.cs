...
public class ApiClient
{
    ...
    public async Task<bool> SubmitAsync(HardwareSpec spec)
    {
        ...
        // Deliberately doesn't print the response body on success — it contains the literal
        // PASS/FAIL result (routes/submit.js), and applicants shouldn't see that; only HR
        // reviewing the dashboard should. Program.cs prints its own generic "submitted, HR will
        // review" message either way.
